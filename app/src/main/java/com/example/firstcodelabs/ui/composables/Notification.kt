...
import com.example.firstcodelabs.ui.theme.myStyle
import com.example.firstcodelabs.ui.theme.newColor
...
fun Notification(
    ...
    // TODO("4.4 Для дочерних элементов так же можно объявлять аргумент modifierЭ)
